...
import com.dvlpxl.contactos.log.Informer;
...
public abstract class Consultor {
    ...
    protected PreparedStatement preparar(boolean generateKeys, String sql, Object... params) {
                PreparedStatement stmt = null;
        try {
            if(generateKeys) stmt = getCon().prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);
            else stmt = getCon().prepareStatement(sql);
            int i = 0;
            for (Object p : params) {
                i++;
            ...
            inf.log(appendError("NullPointerException@Consultor.preparar(boolean, String, Object...). "), Informer.LVL_ERROR);
        }
        return stmt;
    }
     ...
     * @return El PreparedStatement creado.
     */
    protected PreparedStatement preparar(String sql, Object... params) {
        ...
        try {
            ...
            inf.log(appendError("NullPointerException@Consultor.preparar(String, Object...). "), Informer.LVL_ERROR);
        }
        return stmt;
    }
     ...
     * @return Indica si se cerró la conexión.
     */
